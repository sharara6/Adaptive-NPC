...
def summarize_history(
    ...
    for i, e in enumerate(entries):
        ...
        # More detailed history formatting for better LLM context
...
async def analyze_and_respond(user_input: UserInput):
    ...
    persona = (
        ...
        "If they've been consistently negative, become more sinister. If positive, show hints of vulnerability."
    )
